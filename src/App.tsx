  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <AppBar
        ...
        elevation={0}
        sx={{
          background: theme.palette.mode === "dark" ? "#0b1220cc" : "#ffffffcc",
        ...
        <Container maxWidth="lg">
          <Stack spacing={3} textAlign="center" alignItems="center">
            ...
            <Typography variant="h1" sx={{ fontSize: { xs: 40, md: 64 } }}>
              <span className="gradient-text">IT Administracija</span> · Backup
              & Data Recovery · Virtualizacija · 24/7 Monitoring
            </Typography>
            <Typography
              variant="subtitle1"
      ...
      {/* Services Heading */}
      <Container maxWidth="lg">
        <Typography variant="h3" textAlign="center" sx={{ mt: 8 }} gutterBottom>
          Usluge
        </Typography>
        ...
        >
          {services.map((s, i) => (
            <Card key={i} sx={{ height: "100%" }}>
              <CardActionArea href={s.href} onClick={(e) => e.preventDefault()}>
                <CardContent>
                  <Stack spacing={2}>
                    <Avatar
          ...
          >
            <Box flex={1}>
              ...
              <Typography sx={{ opacity: 0.9, mb: 2 }}>
                ...
                fokusirani smo na stabilnost sistema, bezbednost i brz oporavak
                kako bismo minimizirali zastoje i rizike.
              </Typography>
              <Typography sx={{ opacity: 0.9 }}>
                Implementiramo najbolje prakse, automatizujemo rutinske procese
                i obezbeđujemo jasne SLA dogovore. Bilo da je u pitanju malo ili
                srednje preduzeće, pomažemo da IT radi pouzdano, bez
                iznenađenja.
              </Typography>
            </Box>
              ...
              >
                <CardContent>
                  ...
                  <Typography sx={{ mt: 1, opacity: 0.9 }}>
                    Radimo sa klijentima širom regiona i prilagođavamo saradnju
                    vašim potrebama — od jedokratnih intervencija do potpunog
                    upravljanja IT okruženjem.
                  </Typography>
                  <Button
                    variant="contained"
                    size="large"
